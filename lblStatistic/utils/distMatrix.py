...
def compute_ap(recall, precision):
    ...
    if method == "interp":
        ...
        func = np.trapezoid if check_version(np.__version__, ">=2.0") else np.trapz  # type: ignore  np.trapz deprecated
...
class Metric(SimpleClass):
    ...
    def ap50(self):
        ...
        """
        return self.all_ap[:, 0] if len(self.all_ap) else []  # type: ignore
    ...
    def ap(self):
        ...
        """
        return self.all_ap.mean(1) if len(self.all_ap) else []  #type: ignore
    ...
    def mp(self):
        ...
        """
        return self.p.mean() if len(self.p) else 0.0  #type: ignore
    ...
    def mr(self):
        ...
        """
        return self.r.mean() if len(self.r) else 0.0  #type: ignore
    ...
    def map50(self):
        ...
        """
        return self.all_ap[:, 0].mean() if len(self.all_ap) else 0.0  #type: ignore
    ...
    def map75(self):
        ...
        """
        return self.all_ap[:, 5].mean() if len(self.all_ap) else 0.0  #type: ignore
    ...
    def map(self):
        ...
        """
        return self.all_ap.mean() if len(self.all_ap) else 0.0  #type: ignore
